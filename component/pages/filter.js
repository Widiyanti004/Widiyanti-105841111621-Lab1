...
import Icon from 'react-native-vector-icons/MaterialIcons'; // Import ikon dari vector-icons

const Filters = ({ navigation }) => { // Menambahkan props navigation
          ...
          <TouchableOpacity
            ...
            style={[
              styles.colorCircle,
              {
                ...
                borderColor: selectedColors.includes(color) ? 'red' : '#fff', // Set border color to red if selected
              }
            ]}
        ...
        {sizes.map(size => (
          <TouchableOpacity
            ...
            style={[
              styles.sizeButton,
              {
                backgroundColor: selectedSizes.includes(size) ? 'red' : '#fff', // Set background color to red if selected
              }
            ]}
          ...
          >
            <Text style={[
              styles.sizeText,
              {
                color: selectedSizes.includes(size) ? '#fff' : '#000', // Set text color to white if selected
              }
            ]}>
              {size}
            </Text>
        ...
        {categories.map(category => (
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor: selectedCategory === category ? 'red' : '#fff', // Set background color to red if selected
              }
            ]}
          ...
          >
            <Text style={[
              styles.categoryText,
              {
                color: selectedCategory === category ? '#fff' : '#000', // Set text color to white if selected
              }
            ]}>
              {category}
            </Text>
        ...
        {brands.map(brand => (
          <TouchableOpacity
            ...
            style={[
              styles.brandButton,
              {
                backgroundColor: selectedBrands.includes(brand) ? 'red' : '#fff', // Set background color to red if selected
              }
            ]}
          ...
          >
            <Text style={[
              styles.brandText,
              {
                color: selectedBrands.includes(brand) ? '#fff' : '#000', // Set text color to white if selected
              }
            ]}>
              {brand}
            </Text>
